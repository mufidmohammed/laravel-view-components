...
<x-dialog-modal wire:model.live="confirmingPassword">
    ...
    <x-slot name="content">
        ...
        <div class="mt-4" x-data="{}"
            ...
            <x-input type="password" class="mt-1 block w-3/4" label="Confirm Password"
                placeholder="{{ __('Password') }}" autocomplete="current-password" x-ref="confirmable_password"
                wire:model="confirmablePassword" wire:keydown.enter="confirmPassword" name="confirmable_password" />
        </div>
    </x-slot>
